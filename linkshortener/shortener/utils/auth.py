""" Helper class for authentication against a remote auth service """
import logging
import requests
...
from .exceptions import AuthServiceResponseFailed
from .exceptions import UserInfoRetrievalFailed
...
class BearerAuthentication(BaseAuthentication):
    ...
    This authentication class is useful for authenticating an JWT access token against a remote
    ...
    def get_user_info_url(self):
        ...
        return getattr(settings, 'AUTHENTICATION_SERVICE', {})['JWT_VALIDATION_URL']
